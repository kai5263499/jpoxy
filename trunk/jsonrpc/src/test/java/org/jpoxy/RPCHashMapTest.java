...
public class RPCHashMapTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        sh.setInitParameter("rpcclasses", "org.jpoxy.ClassD");
    ...
    public void testAddMethod() throws Exception {
        ...
        String requests = "GET /api?method=add&a=1&b=2"+
                " HTTP/1.1\r\n" + "Host: tester\r\n" + "\r\n";
        ...
        assertEquals(3, jsonObj.getInt("result"));
    }
}
